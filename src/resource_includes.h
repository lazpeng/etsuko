...
static const char incbin_default_vert_shader[] = {
#embed "shaders/default.vert.glsl"
    ,'\0'
};
static const char incbin_fullscreen_quad_vert_shader[] = {
#embed "shaders/fsq.vert.glsl"
    ,'\0'
};
